# 1 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc005_selectinglists_1\\\\combined_UC005_SelectingLists_1.c"
...
# 1 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc005_selectinglists_1\\\\combined_UC005_SelectingLists_1.c" 2
...
# 2 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc005_selectinglists_1\\\\combined_UC005_SelectingLists_1.c" 2
...
# 3 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc005_selectinglists_1\\\\combined_UC005_SelectingLists_1.c" 2
...
# 4 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc005_selectinglists_1\\\\combined_UC005_SelectingLists_1.c" 2

# 1 "Action.c" 1
Action()
{
	int randNumber; 
 	randNumber = rand()%60 + 1;   
 	
 	 
 	
 	lr_save_datetime("%m/%d/%Y", 0 + 86400*randNumber, "departD"); 
 	 
 	
 	lr_save_datetime("%m/%d/%Y", 0 + (86400*randNumber) + (86400*2), "returnD");
 	 
	
 	lr_start_transaction(tr_main = "5_MAIN_SelectingList");
	...
	web_url("WebTours", 
 	...
 	lr_start_transaction(tr_name = "Login");  
	...
	lr_start_transaction(tr_name = "Click_Flights");  
	...
	lr_start_transaction(tr_name = "Fill_Flight");  
	...
	lr_end_transaction("Fill_Flight",2);

	lr_think_time(3);

	lr_start_transaction(tr_name = "Choose_Flight");  
	...
	lr_start_transaction(tr_name = "Logout");  

	Logout();

	lr_end_transaction("Logout",2);
	lr_end_transaction("5_MAIN_SelectingList",2);
	
	return 0;
}
# 5 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc005_selectinglists_1\\\\combined_UC005_SelectingLists_1.c" 2
...
Check(int status, char *tr_name)
{
	if(status == 1){
		...
		lr_end_transaction(tr_name, 1);
		lr_end_transaction("5_MAIN_SelectingList", 1);
		Relogin();
		lr_exit(5, 1);
	}
	return 0;
...
Relogin()
{
	...
	lr_save_datetime("%d.%m.%Y %H:%M:%S", 0, "currDateTime");
	...
	lr_end_transaction("_UC005_SelectingLists_Relogin", 1);
...
# 6 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc005_selectinglists_1\\\\combined_UC005_SelectingLists_1.c" 2
...
# 7 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc005_selectinglists_1\\\\combined_UC005_SelectingLists_1.c" 2
