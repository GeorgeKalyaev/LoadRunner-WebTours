# 1 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc003_registrationuser_1\\\\combined_UC003_RegistrationUser_1.c"
...
# 1 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc003_registrationuser_1\\\\combined_UC003_RegistrationUser_1.c" 2
...
# 2 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc003_registrationuser_1\\\\combined_UC003_RegistrationUser_1.c" 2
...
# 3 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc003_registrationuser_1\\\\combined_UC003_RegistrationUser_1.c" 2
...
# 4 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc003_registrationuser_1\\\\combined_UC003_RegistrationUser_1.c" 2
...
Action()
{
	...
	lr_end_transaction("Click_SignUpNow",2);
	...
	lr_end_transaction("Fillform_RegistrationUser",2);
	...
	lr_end_transaction("3_MAIN_RegistrationUser",2);

	return 0;
}
# 5 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc003_registrationuser_1\\\\combined_UC003_RegistrationUser_1.c" 2
...
Check(int status, char *tr_name)
{
	if(status == 1){
		...
		lr_end_transaction("3_MAIN_RegistrationUser", 1);
		lr_exit(5, 1);
	}
	
	return 0;
}
# 6 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc003_registrationuser_1\\\\combined_UC003_RegistrationUser_1.c" 2
...
# 7 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc003_registrationuser_1\\\\combined_UC003_RegistrationUser_1.c" 2
