# 1 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc001_buyticket_1\\\\combined_UC001_BuyTicket_1.c"
...
# 1 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc001_buyticket_1\\\\combined_UC001_BuyTicket_1.c" 2
...
# 2 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc001_buyticket_1\\\\combined_UC001_BuyTicket_1.c" 2
...
# 3 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc001_buyticket_1\\\\combined_UC001_BuyTicket_1.c" 2
...
# 4 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc001_buyticket_1\\\\combined_UC001_BuyTicket_1.c" 2
...
Action()
{
	...
	lr_start_transaction(tr_name = "Fill_Payment_Info");  
	...
	lr_end_transaction("Fill_Payment_Info",2);
	...
	lr_end_transaction("1_MAIN_BuyTicket",2);
	
	return 0;
}
# 5 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc001_buyticket_1\\\\combined_UC001_BuyTicket_1.c" 2
...
Check(int status, char *tr_name)
{
	if(status == 1){
		...
		lr_end_transaction("1_MAIN_BuyTicket", 1);
		Relogin();
		lr_exit(5, 1);
	}
	return 0;
...
Relogin()
{
	...
	lr_end_transaction("_UC001_WebTours_1_Relogin", 1);
...
# 6 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc001_buyticket_1\\\\combined_UC001_BuyTicket_1.c" 2
...
# 7 "c:\\users\\kalya\\documents\\sharpdevelop projects\\uc001_buyticket_1\\\\combined_UC001_BuyTicket_1.c" 2
